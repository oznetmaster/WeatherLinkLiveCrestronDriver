# WeatherLinkLiveCrestronDriver processor workflow
...
```powershell
dotnet test WeatherLinkLiveCrestronDriver.WorkflowTests/WeatherLinkLiveCrestronDriver.WorkflowTests.csproj -c Release --list-tests
dotnet test WeatherLinkLiveCrestronDriver.WorkflowTests/WeatherLinkLiveCrestronDriver.WorkflowTests.csproj -c Release --filter FullyQualifiedName=CrestronHome.Workflows.weatherlinklivecrestrondriver_driver
```
